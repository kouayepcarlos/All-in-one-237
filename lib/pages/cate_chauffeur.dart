...
class CategorieChauffeur extends StatefulWidget {
  const CategorieChauffeur({super.key});

  @override
  State<CategorieChauffeur> createState() => _CategorieChauffeurState();
}

class _CategorieChauffeurState extends State<CategorieChauffeur> {
  
   final Stream<QuerySnapshot> _produitRef = FirebaseFirestore.instance.collection('Prestataires').where('categorie', isEqualTo: "Chauffeurs").snapshots();
  @override
...
Container(
    ...
    return Scaffold(
       appBar: AppBar(
        title: const Text("Catégorie Chauffeur", style: TextStyle(color: Colors.deepOrange),),
          ...
          children: [
                  ...
                  children: [
                    ...
                    decoration: const BoxDecoration(
                      image: DecorationImage(
                        image: AssetImage('assets/chauffe.jpg'),
                        fit: BoxFit.cover 
                        )
                    ),
                    ...
                    child: Container(
                      ...
                      child: Padding(padding: EdgeInsets.only(top:200),
                        child: Column(
                          children:const  [
                            Text("Retrouvez les meilleurs Chauffeurs", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Colors.white),)
                          ],
                        ),
                      ),
                    ),
                 ...
                 Padding(
                                     ...
                                     child: Row(
                                                         ...
                                                         children: const [
                                                           Text("Catégorie Chauffeur", style: TextStyle(color: Colors.blue, fontWeight: FontWeight.bold,fontSize: 17),),
 ...
 return Scaffold(
       appBar: AppBar(
        title: const Text("Catégorie Chauffeur", style: TextStyle(color: Colors.white),),
