...
class CategorieWhisky extends StatefulWidget {
  const CategorieWhisky({super.key});

  @override
  State<CategorieWhisky> createState() => _CategorieWhiskyState();
}

class _CategorieWhiskyState extends State<CategorieWhisky> {
      final Stream<QuerySnapshot> _produitRef = FirebaseFirestore.instance.collection('Produit').where('categorie', isEqualTo: "Whisky").snapshots();
  @override
...
Container(
    ...
    return Scaffold(
             appBar: AppBar(
        title: const Text("Catégorie Whisky", style: TextStyle(color: Colors.deepOrange),),
                  ...
                  children: [
                    ...
                    child: Container(
                      ...
                      child: Padding(padding: EdgeInsets.only(top:200),
                        child: Column(
                          children:const  [
                            Text("Retrouvez les meilleurs Whisky", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Colors.white),)
                          ],
                        ),
                      ),
                    ),
                      ...
                      Padding(
                                     ...
                                     child: Row(
                                                         ...
                                                         children: const [
                                                           Text("Catégorie Whisky", style: TextStyle(color: Colors.blue, fontWeight: FontWeight.bold,fontSize: 17),),
