...
class CategorieElectricite extends StatefulWidget {
  const CategorieElectricite({super.key});

  @override
  State<CategorieElectricite> createState() => _CategorieElectriciteState();
}

class _CategorieElectriciteState extends State<CategorieElectricite> {
 
  final Stream<QuerySnapshot> _produitRef = FirebaseFirestore.instance.collection('Prestataires').where('categorie', isEqualTo: "Electricité").snapshots();
...
Container(
    ...
    return Scaffold(
       appBar: AppBar(
        title: const Text("Catégorie Électricité", style: TextStyle(color: Colors.deepOrange),),
          ...
          children: [
                  ...
                  children: [
                    ...
                    child: Container(
                      ...
                      child: Padding(padding: EdgeInsets.only(top:200),
                        child: Column(
                          children:const  [
                            Text("Retrouvez les meilleurs Électriciens", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Colors.white),)
                          ],
                        ),
                      ),
                    ),
                 ...
                 Padding(
                                     ...
                                     child: Row(
                                                         ...
                                                         children: const [
                                                           Text("Catégorie Électricité", style: TextStyle(color: Colors.blue, fontWeight: FontWeight.bold,fontSize: 17),),
...
return Scaffold(
       appBar: AppBar(
        title: const Text("Categorie Électricité", style: TextStyle(color: Colors.white),),
