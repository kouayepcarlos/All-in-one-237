...
class CategorieAutre extends StatefulWidget {
  const CategorieAutre({super.key});

  @override
  State<CategorieAutre> createState() => _CategorieAutreState();
}

class _CategorieAutreState extends State<CategorieAutre> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
             appBar: AppBar(
        title: const Text("Catégorie Autre", style: TextStyle(color: Colors.white),),
                 ...
                 Column(
                  ...
                  children: [
                    ...
                    child: Container(
                      ...
                      child: Padding(padding: EdgeInsets.only(top:200),
                        child: Column(
                          children:const  [
                            Text("Retrouvez les meilleurs Produits", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Colors.white),)
                          ],
                        ),
                      ),
                    ),
                  ...
                  Padding(
                                     ...
                                     child: Row(
                                                         ...
                                                         children: const [
                                                           Text("Catégorie Autre", style: TextStyle(color: Colors.blue, fontWeight: FontWeight.bold,fontSize: 17),),
