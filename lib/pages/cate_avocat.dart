...
class CategorieAvocat extends StatefulWidget {
  const CategorieAvocat({super.key});

  @override
  State<CategorieAvocat> createState() => _CategorieAvocatState();
}

class _CategorieAvocatState extends State<CategorieAvocat> {
  final Stream<QuerySnapshot> _produitRef = FirebaseFirestore.instance.collection('Prestataires').where('categorie', isEqualTo: "Avocat").snapshots();
  @override
...
Container(
    ...
    return Scaffold(
       appBar: AppBar(
        title: const Text("Catégorie Avocat", style: TextStyle(color: Colors.deepOrange),),
          ...
          children: [
                  ...
                  children: [
                    ...
                    decoration: const BoxDecoration(
                      image: DecorationImage(
                        image: AssetImage('assets/avocat.jpg'),
                        fit: BoxFit.cover 
                        )
                    ),
                    ...
                    child: Container(
                      ...
                      child: Padding(padding: EdgeInsets.only(top:200),
                        child: Column(
                          children:const  [
                            Text("Retrouvez les meilleurs Avocat(e)s", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Colors.white),)
                          ],
                        ),
                      ),
                    ),
                 ...
                 Padding(
                                     ...
                                     child: Row(
                                                         ...
                                                         children: const [
                                                           Text("Catégorie Avocat", style: TextStyle(color: Colors.blue, fontWeight: FontWeight.bold,fontSize: 17),),
 ...
 return Scaffold(
       appBar: AppBar(
        title: const Text("Catégorie Avocat", style: TextStyle(color: Colors.white),),
