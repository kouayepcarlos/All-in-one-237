...
class CategorieFrigoriste extends StatefulWidget {
  const CategorieFrigoriste({super.key});

  @override
  State<CategorieFrigoriste> createState() => _CategorieFrigoristeState();
}

class _CategorieFrigoristeState extends State<CategorieFrigoriste> {

  final Stream<QuerySnapshot> _produitRef = FirebaseFirestore.instance.collection('Prestataires').where('categorie', isEqualTo: "Frigoriste").snapshots();
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
       appBar: AppBar(
        title: const Text("Catégorie Frigoriste", style: TextStyle(color: Colors.deepOrange),),
                  ...
                  children: [
                    ...
                    decoration: const BoxDecoration(
                      image: DecorationImage(
                        image: AssetImage('assets/colla.png'),
                        fit: BoxFit.cover 
                        )
                    ),
                    ...
                    child: Container(
                      ...
                      child: Padding(padding: EdgeInsets.only(top:200),
                        child: Column(
                          children:const  [
                            Text("Retrouvez les meilleurs Frigoristes", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Colors.white),)
                          ],
                        ),
                      ),
                    ),
                    ...
                    Padding(
                                     ...
                                     child: Row(
                                                         ...
                                                         children: const [
                                                           Text("Catégorie Frigoriste", style: TextStyle(color: Colors.blue, fontWeight: FontWeight.bold,fontSize: 17),),
     ...
     if(snapshot.hasError){
       ...
       return Scaffold(
       appBar: AppBar(
        title: const Text("Catégorie Frigoriste", style: TextStyle(color: Colors.white),),
