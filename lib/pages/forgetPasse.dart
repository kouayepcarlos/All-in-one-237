...
class ForgetPasse extends StatefulWidget {

  const ForgetPasse({super.key});

  @override
  State<ForgetPasse> createState() => _ForgetPasseState();
}

class _ForgetPasseState extends State<ForgetPasse> {
  ...
  Widget build(BuildContext context) {
    return loading ? Loading() :Scaffold(
      appBar: AppBar(
        title: const Text("Mot de passe oublié", style: TextStyle(color: Colors.deepOrange),),
        backgroundColor: Colors.white,
        elevation: 0,
        leading : IconButton(
          onPressed: ()=> Navigator.pushReplacementNamed(context, '/prestataire'),
