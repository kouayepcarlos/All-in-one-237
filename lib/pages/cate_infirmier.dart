...
class CategorieInfirmier extends StatefulWidget {
  const CategorieInfirmier({super.key});

  @override
  State<CategorieInfirmier> createState() => _CategorieInfirmierState();
}

class _CategorieInfirmierState extends State<CategorieInfirmier> {
 
  
  final Stream<QuerySnapshot> _produitRef = FirebaseFirestore.instance.collection('Prestataires').where('categorie', isEqualTo: "Infirmiers").snapshots();
  @override
...
Container(
    ...
    return Scaffold(
       appBar: AppBar(
        title: const Text("Catégorie Infirmier", style: TextStyle(color: Colors.deepOrange),),
                  ...
                  children: [
                    ...
                    child: Container(
                      ...
                      child: Padding(padding: EdgeInsets.only(top:200),
                        child: Column(
                          children:const  [
                            Text("Retrouvez les meilleurs Infirmier(e)s", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Colors.white),)
                          ],
                        ),
                      ),
                    ),
                    ...
                    Padding(
                                     ...
                                     child: Row(
                                                         ...
                                                         children: const [
                                                           Text("Catégorie Infirmier", style: TextStyle(color: Colors.blue, fontWeight: FontWeight.bold,fontSize: 17),),
...
return Scaffold(
       appBar: AppBar(
        title: const Text("Catégorie Infirmier", style: TextStyle(color: Colors.white),),
