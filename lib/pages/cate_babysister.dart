...
class CategorieBabysister extends StatefulWidget {
  const CategorieBabysister({super.key});

  @override
  State<CategorieBabysister> createState() => _CategorieBabysisterState();
}

class _CategorieBabysisterState extends State<CategorieBabysister> {
   final Stream<QuerySnapshot> _produitRef = FirebaseFirestore.instance.collection('Prestataires').where('categorie', isEqualTo: "BabySister").snapshots();
  @override
...
Container(
    ...
    return Scaffold(
       appBar: AppBar(
        title: const Text("Catégorie Babysister", style: TextStyle(color: Colors.deepOrange),),
          ...
          children: [
                  ...
                  children: [
                    ...
                    child: Container(
                      ...
                      child: Padding(padding: EdgeInsets.only(top:200),
                        child: Column(
                          children:const  [
                            Text("Retrouvez des Babysister", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Colors.white),)
                          ],
                        ),
                      ),
                    ),
                 ...
                 Padding(
                                     ...
                                     child: Row(
                                                         ...
                                                         children: const [
                                                           Text("Catégorie Babysister", style: TextStyle(color: Colors.blue, fontWeight: FontWeight.bold,fontSize: 17),),
 ...
 return Scaffold(
       appBar: AppBar(
        title: const Text("Catégorie Babysister", style: TextStyle(color: Colors.white),),
