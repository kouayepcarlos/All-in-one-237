...
class CategorieMecanique extends StatefulWidget {
  const CategorieMecanique({super.key});

  @override
  State<CategorieMecanique> createState() => _CategorieMecaniqueState();
}

class _CategorieMecaniqueState extends State<CategorieMecanique> {
  
  final Stream<QuerySnapshot> _produitRef = FirebaseFirestore.instance.collection('Prestataires').where('categorie', isEqualTo: "Mecaniciens").snapshots();
  @override
...
Container(
    ...
    return Scaffold(
       appBar: AppBar(
        title: const Text("Catégorie Mecanique", style: TextStyle(color: Colors.deepOrange),),
                  ...
                  children: [
                    ...
                    decoration: const BoxDecoration(
                      image: DecorationImage(
                        image: AssetImage('assets/mecan.jpg'),
                        fit: BoxFit.cover 
                        )
                    ),
                    ...
                    child: Container(
                      ...
                      child: Padding(padding: EdgeInsets.only(top:200),
                        child: Column(
                          children:const  [
                            Text("Retrouvez les meilleurs Mecaniciens", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Colors.white),)
                          ],
                        ),
                      ),
                    ),
...
return Scaffold(
       appBar: AppBar(
        title: const Text("Catégorie Mecanique", style: TextStyle(color: Colors.white),),
