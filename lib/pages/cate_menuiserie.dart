...
class CategorieMenuiserie extends StatefulWidget {
  const CategorieMenuiserie({super.key});

  @override
  State<CategorieMenuiserie> createState() => _CategorieMenuiserieState();
}

class _CategorieMenuiserieState extends State<CategorieMenuiserie> {
  
    final Stream<QuerySnapshot> _produitRef = FirebaseFirestore.instance.collection('Prestataires').where('categorie', isEqualTo: "Menuisierie").snapshots();
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
       appBar: AppBar(
        title: const Text("Catégorie Menuiserie", style: TextStyle(color: Colors.deepOrange),),
          ...
          children: [
                  ...
                  children: [
                    ...
                    decoration: const BoxDecoration(
                      image: DecorationImage(
                        image: AssetImage('assets/menuserie.jpg'),
                        fit: BoxFit.cover 
                        )
                    ),
                    ...
                    child: Container(
                      ...
                      child: Padding(padding: EdgeInsets.only(top:200),
                        child: Column(
                          children:const  [
                            Text("Retrouvez les meilleurs Menuisiers", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Colors.white),)
                          ],
                        ),
                      ),
                    ),
                ...
                Padding(
                                     ...
                                     child: Row(
                                                         ...
                                                         children: const [
                                                           Text("Catégorie Menuiserie", style: TextStyle(color: Colors.blue, fontWeight: FontWeight.bold,fontSize: 17),),
...
return Scaffold(
       appBar: AppBar(
        title: const Text("Catégorie Menuiserie", style: TextStyle(color: Colors.white),),
