...
class CategoriePLomberie extends StatefulWidget {
  const CategoriePLomberie({super.key});

  @override
  State<CategoriePLomberie> createState() => _CategoriePLomberieState();
}

class _CategoriePLomberieState extends State<CategoriePLomberie> {
  
      final Stream<QuerySnapshot> _produitRef = FirebaseFirestore.instance.collection('Prestataires').where('categorie', isEqualTo: "Plomberie").snapshots();
  @override
...
Container(
    ...
    return Scaffold(
       appBar: AppBar(
        title: const Text("Catégorie Plomberie", style: TextStyle(color: Colors.deepOrange),),
          ...
          children: [
                  ...
                  children: [
                    ...
                    decoration: const BoxDecoration(
                      image: DecorationImage(
                        image: AssetImage('assets/plom.jpg'),
                        fit: BoxFit.cover 
                        )
                    ),
                    ...
                    child: Container(
                      ...
                      child: Padding(padding: EdgeInsets.only(top:200),
                        child: Column(
                          children:const  [
                            Text("Retrouvez les meilleurs Plombiers", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Colors.white),)
                          ],
                        ),
                      ),
                    ),
                ...
                Padding(
                                     ...
                                     child: Row(
                                                         ...
                                                         children: const [
                                                           Text("Catégorie Plomberie", style: TextStyle(color: Colors.blue, fontWeight: FontWeight.bold,fontSize: 17),),
    ...
    if(snapshot.hasError){
      return Scaffold(
       appBar: AppBar(
        title: const Text("Catégorie Plomberie", style: TextStyle(color: Colors.white),),
