...
class CategorieGardinnage extends StatefulWidget {
  const CategorieGardinnage({super.key});

  @override
  State<CategorieGardinnage> createState() => _CategorieGardinnageState();
}

class _CategorieGardinnageState extends State<CategorieGardinnage> {
   
  final Stream<QuerySnapshot> _produitRef = FirebaseFirestore.instance.collection('Prestataires').where('categorie', isEqualTo: "Gardinnages").snapshots();
  @override
...
Container(
    ...
    return Scaffold(
       appBar: AppBar(
        title: const Text("Catégorie Gardinnage", style: TextStyle(color: Colors.deepOrange),),
                  ...
                  children: [
                    ...
                    decoration: const BoxDecoration(
                      image: DecorationImage(
                        image: AssetImage('assets/garde.jpg'),
                        fit: BoxFit.cover 
                        )
                    ),
                    ...
                    child: Container(
                      ...
                      child: Padding(padding: EdgeInsets.only(top:200),
                        child: Column(
                          children:const  [
                            Text("Retrouvez les meilleurs Gardiens", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Colors.white),)
                          ],
                        ),
                      ),
                    ),
                    ...
                    Padding(
                                     ...
                                     child: Row(
                                                         ...
                                                         children: const [
                                                           Text("Catégorie Gardinnage", style: TextStyle(color: Colors.blue, fontWeight: FontWeight.bold,fontSize: 17),),
...
return Scaffold(
       appBar: AppBar(
        title: const Text("Catégorie Gardinnage", style: TextStyle(color: Colors.white),),
