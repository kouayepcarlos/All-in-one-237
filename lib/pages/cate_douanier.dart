...
class CategorieDouanier extends StatefulWidget {
  const CategorieDouanier({super.key});

  @override
  State<CategorieDouanier> createState() => _CategorieDouanierState();
}

class _CategorieDouanierState extends State<CategorieDouanier> {

  final Stream<QuerySnapshot> _produitRef = FirebaseFirestore.instance.collection('Prestataires').where('categorie', isEqualTo: "Déclarant en douane").snapshots();
  @override
...
Container(
       ...
       return Scaffold(
       appBar: AppBar(
        title: const Text("Catégorie Douanier", style: TextStyle(color: Colors.deepOrange),),
          ...
          children: [
                  ...
                  children: [
                    ...
                    decoration: const BoxDecoration(
                      image: DecorationImage(
                        image: AssetImage('assets/douanier.jpg'),
                        fit: BoxFit.cover 
                        )
                    ),
                    ...
                    child: Container(
                      ...
                      child: Padding(padding: EdgeInsets.only(top:200),
                        child: Column(
                          children:const  [
                            Text("Retrouvez les meilleurs Douniers", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Colors.white),)
                          ],
                        ),
                      ),
                    ),
                 ...
                 Padding(
                                     ...
                                     child: Row(
                                                         ...
                                                         children: const [
                                                           Text("Catégorie Douanier", style: TextStyle(color: Colors.blue, fontWeight: FontWeight.bold,fontSize: 17),),
  ...
  return Scaffold(
       appBar: AppBar(
        title: const Text("Categorie Douanier", style: TextStyle(color: Colors.white),),
