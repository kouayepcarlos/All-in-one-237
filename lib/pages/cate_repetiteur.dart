...
class CategorieRepetiteur extends StatefulWidget {
  const CategorieRepetiteur({super.key});

  @override
  State<CategorieRepetiteur> createState() => _CategorieRepetiteurState();
}

class _CategorieRepetiteurState extends State<CategorieRepetiteur> {
     final Stream<QuerySnapshot> _produitRef = FirebaseFirestore.instance.collection('Prestataires').where('categorie', isEqualTo: "Répetiteurs").snapshots();
  @override
...
Container(
    ...
    return Scaffold(
       appBar: AppBar(
        title: const Text("Catégorie Répétiteur", style: TextStyle(color: Colors.deepOrange),),
                 ...
                 Column(
                  ...
                  children: [
                    ...
                    decoration: const BoxDecoration(
                      image: DecorationImage(
                        image: AssetImage('assets/repeti.jpg'),
                        fit: BoxFit.cover 
                        )
                    ),
                    ...
                    child: Container(
                      ...
                      child: Padding(padding: EdgeInsets.only(top:200),
                        child: Column(
                          children:const  [
                            Text("Retrouvez les meilleurs Répétiteurs", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Colors.white),)
                          ],
                        ),
                      ),
                    ),
                  ...
                  Padding(
                                     ...
                                     child: Row(
                                                         ...
                                                         children: const [
                                                           Text("Catégorie Répétiteur", style: TextStyle(color: Colors.blue, fontWeight: FontWeight.bold,fontSize: 17),),
     ...
     if(snapshot.hasError){
        return Scaffold(
       appBar: AppBar(
        title: const Text("Catégorie Répétiteur", style: TextStyle(color: Colors.white),),
       ...
       body: SingleChildScrollView(
        child: Column(
          children: [
              ...
              Container(
                child: Text("Aucune prestation pour le moment", textAlign: TextAlign.center,style: TextStyle(fontSize: 16, color: Colors.deepOrange, fontWeight: FontWeight.bold),),
              )
          ],
        ),
      ),
