...
class CategorieJuriste extends StatefulWidget {
  const CategorieJuriste({super.key});

  @override
  State<CategorieJuriste> createState() => _CategorieJuristeState();
}

class _CategorieJuristeState extends State<CategorieJuriste> {
   
  final Stream<QuerySnapshot> _produitRef = FirebaseFirestore.instance.collection('Prestataires').where('categorie', isEqualTo: "Juriste").snapshots();
  @override
...
Container(
    ...
    return Scaffold(
       appBar: AppBar(
        title: const Text("Catégorie Juriste", style: TextStyle(color: Colors.deepOrange),),
                  ...
                  children: [
                    ...
                    decoration: const BoxDecoration(
                      image: DecorationImage(
                        image: AssetImage('assets/juriste1.png'),
                        fit: BoxFit.cover 
                        )
                    ),
                    ...
                    child: Container(
                      ...
                      child: Padding(padding: EdgeInsets.only(top:200),
                        child: Column(
                          children:const  [
                            Text("Retrouvez les meilleurs Juristes", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Colors.white),)
                          ],
                        ),
                      ),
                    ),
                    ...
                    Padding(
                                     ...
                                     child: Row(
                                                         ...
                                                         children: const [
                                                           Text("Catégorie Juriste", style: TextStyle(color: Colors.blue, fontWeight: FontWeight.bold,fontSize: 17),),
    ...
    return Scaffold(
       appBar: AppBar(
        title: const Text("Catégorie Juriste", style: TextStyle(color: Colors.white),),
