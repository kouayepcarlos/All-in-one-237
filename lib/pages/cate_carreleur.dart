...
class CategorieCarreleur extends StatefulWidget {
  const CategorieCarreleur({super.key});

  @override
  State<CategorieCarreleur> createState() => _CategorieCarreleurState();
}

class _CategorieCarreleurState extends State<CategorieCarreleur> {
  final Stream<QuerySnapshot> _produitRef = FirebaseFirestore.instance.collection('Prestataires').where('categorie', isEqualTo: "Carreleur").snapshots();
...
Container(
    ...
    return Scaffold(
       appBar: AppBar(
        title: const Text("Catégorie Carreleur", style: TextStyle(color: Colors.deepOrange),),
          ...
          children: [
                  ...
                  children: [
                    ...
                    child: Container(
                      ...
                      child: Padding(padding: EdgeInsets.only(top:200),
                        child: Column(
                          children:const  [
                            Text("Retrouvez les meilleurs carrelleurs", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Colors.white),)
                          ],
                        ),
                      ),
                    ),
                 ...
                 Padding(
                                     ...
                                     child: Row(
                                                         ...
                                                         children: const [
                                                           Text("Catégorie Carreleur", style: TextStyle(color: Colors.blue, fontWeight: FontWeight.bold,fontSize: 17),),
...
return Scaffold(
       appBar: AppBar(
        title: const Text("Categorie Carreleur", style: TextStyle(color: Colors.white),),
