...
class CategorieChaussure extends StatefulWidget {
  const CategorieChaussure({super.key});

  @override
  State<CategorieChaussure> createState() => _CategorieChaussureState();
}

class _CategorieChaussureState extends State<CategorieChaussure> {
  final Stream<QuerySnapshot> _produitRef = FirebaseFirestore.instance.collection('Produit').where('categorie', isEqualTo: "Chaussures").snapshots();
  @override
...
Container(
    ...
    return Scaffold(
             appBar: AppBar(
        title: const Text("Catégorie Chaussure", style: TextStyle(color: Colors.deepOrange),),
                 ...
                 Column(
                  ...
                  children: [
                    ...
                    decoration: const BoxDecoration(
                      image: DecorationImage(
                        image: AssetImage('assets/chaussure.jpeg'),
                        fit: BoxFit.cover 
                        )
                    ),
                    ...
                    child: Container(
                      ...
                      child: Padding(padding: EdgeInsets.only(top:200),
                        child: Column(
                          children:const  [
                            Text("Retrouvez les meilleurs Chaussures", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Colors.white),)
                          ],
                        ),
                      ),
                    ),
                  ...
                  Padding(
                                     ...
                                     child: Row(
                                                         ...
                                                         children: const [
                                                           Text("Catégorie Chaussure", style: TextStyle(color: Colors.blue, fontWeight: FontWeight.bold,fontSize: 17),),
