...
class CategorieParfum extends StatefulWidget {
  const CategorieParfum({super.key});

  @override
  State<CategorieParfum> createState() => _CategorieParfumState();
}

class _CategorieParfumState extends State<CategorieParfum> {
  final Stream<QuerySnapshot> _produitRef = FirebaseFirestore.instance.collection('Produit').where('categorie', isEqualTo: "Parfuns").snapshots();
  @override
...
Container(
    ...
    return Scaffold(
             appBar: AppBar(
        title: const Text("Catégorie Parfun", style: TextStyle(color: Colors.deepOrange),),
          ...
          children: [
                  ...
                  children: [
                    ...
                    decoration: const BoxDecoration(
                      image: DecorationImage(
                        image: AssetImage('assets/parfun.jpg'),
                        fit: BoxFit.cover 
                        )
                    ),
                    ...
                    child: Container(
                      ...
                      child: Padding(padding: EdgeInsets.only(top:200),
                        child: Column(
                          children:const  [
                            Text("Retrouvez les meilleurs Parfuns", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Colors.white),)
                          ],
                        ),
                      ),
                    ),
                ...
                Padding(
                                     ...
                                     child: Row(
                                                         ...
                                                         children: const [
                                                           Text("Catégorie Parfun", style: TextStyle(color: Colors.blue, fontWeight: FontWeight.bold,fontSize: 17),),
