...
class CategorieBijoux extends StatefulWidget {
  const CategorieBijoux({super.key});

  @override
  State<CategorieBijoux> createState() => _CategorieBijouxState();
}

class _CategorieBijouxState extends State<CategorieBijoux> {
  final Stream<QuerySnapshot> _produitRef = FirebaseFirestore.instance.collection('Produit').where('categorie', isEqualTo: "Bijoux").snapshots();
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
             appBar: AppBar(
        title: const Text("Catégorie Bijoux", style: TextStyle(color: Colors.deepOrange),),
                 ...
                 Column(
                  ...
                  children: [
                    ...
                    decoration: const BoxDecoration(
                      image: DecorationImage(
                        image: AssetImage('assets/bijou.jpg'),
                        fit: BoxFit.cover 
                        )
                    ),
                    ...
                    child: Container(
                      ...
                      child: Padding(padding: EdgeInsets.only(top:200),
                        child: Column(
                          children:const  [
                            Text("Retrouvez les meilleurs Bijoux", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Colors.white),)
                          ],
                        ),
                      ),
                    ),
                  ...
                  Padding(
                                     ...
                                     child: Row(
                                                         ...
                                                         children: const [
                                                           Text("Catégorie Bijoux", style: TextStyle(color: Colors.blue, fontWeight: FontWeight.bold,fontSize: 17),),
