...
class CategorieTelephone extends StatefulWidget {
  const CategorieTelephone({super.key});

  @override
  State<CategorieTelephone> createState() => _CategorieTelephoneState();
}

class _CategorieTelephoneState extends State<CategorieTelephone> {
  final Stream<QuerySnapshot> _produitRef = FirebaseFirestore.instance.collection('Produit').where('categorie', isEqualTo: "Téléphones").snapshots();
  @override
...
Container(
    ...
    return Scaffold(
             appBar: AppBar(
        title: const Text("Catégorie Téléphones", style: TextStyle(color: Colors.deepOrange),),
          ...
          children: [
                  ...
                  children: [
                    ...
                    child: Container(
                      ...
                      child: Padding(padding: EdgeInsets.only(top:200),
                        child: Column(
                          children:const  [
                            Text("Retrouvez les meilleurs Téléphones", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Colors.white),)
                          ],
                        ),
                      ),
                    ),
                ...
                Padding(
                                     ...
                                     child: Row(
                                                         ...
                                                         children: const [
                                                           Text("Catégorie Téléphone", style: TextStyle(color: Colors.blue, fontWeight: FontWeight.bold,fontSize: 17),),
