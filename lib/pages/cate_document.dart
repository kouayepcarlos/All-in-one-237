...
class CategorieDocument extends StatefulWidget {
  const CategorieDocument({super.key});

  @override
  State<CategorieDocument> createState() => _CategorieDocumentState();
}

class _CategorieDocumentState extends State<CategorieDocument> {

  final Stream<QuerySnapshot> _produitRef = FirebaseFirestore.instance.collection('Produit').where('categorie', isEqualTo: "Documents").snapshots();
  @override
...
Container(
    ...
    return Scaffold(
             appBar: AppBar(
        title: const Text("Catégorie Document", style: TextStyle(color: Colors.deepOrange),),
                 ...
                 Column(
                  ...
                  children: [
                    ...
                    child: Container(
                      ...
                      child: Padding(padding: EdgeInsets.only(top:200),
                        child: Column(
                          children:const  [
                            Text("Retrouvez les meilleurs Documents", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Colors.white),)
                          ],
                        ),
                      ),
                    ),
                  ...
                  Padding(
                                     ...
                                     child: Row(
                                                         ...
                                                         children: const [
                                                           Text("Catégorie Document", style: TextStyle(color: Colors.blue, fontWeight: FontWeight.bold,fontSize: 17),),
