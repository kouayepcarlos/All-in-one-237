...
class CategorieInformatique extends StatefulWidget {
  const CategorieInformatique({super.key});

  @override
  State<CategorieInformatique> createState() => _CategorieInformatiqueState();
}

class _CategorieInformatiqueState extends State<CategorieInformatique> {
   final Stream<QuerySnapshot> _produitRef = FirebaseFirestore.instance.collection('Prestataires').where('categorie', isEqualTo: "Informaticiens").snapshots();
  @override
  Widget build(BuildContext context) {
    return Container(
      ...
      return Scaffold(
       appBar: AppBar(
        title: const Text("Catégorie Informatique", style: TextStyle(color: Colors.deepOrange),),
        ...
        child: Column(
          children: [
                  ...
                  children: [
                    ...
                    child: Container(
                      ...
                      child: Padding(padding: EdgeInsets.only(top:200),
                        child: Column(
                          children:const  [
                            Text("Retrouvez les meilleurs Informaticiens", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Colors.white),)
                          ],
                        ),
                      ),
                    ),
                                   ...
                                   Padding(
                                     ...
                                     child: Row(
                                                         ...
                                                         children: const [
                                                           Text("Catégorie Numérique", style: TextStyle(color: Colors.blue, fontWeight: FontWeight.bold,fontSize: 17),),
               ...
               child: Padding(
                  ...
                  return  Scaffold(
       appBar: AppBar(
        title: const Text("Categorie Informatique", style: TextStyle(color: Colors.white),),
            ...
            child: InkWell(
              ...
              child: Column(
                ...
                const SizedBox(height: 1,),
                 ...
                 Expanded(child: Text(description.substring(0,35)+'...',style:const TextStyle(fontSize: 16, fontWeight: FontWeight.w600, color:Colors.black))),
