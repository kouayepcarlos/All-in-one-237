...
class CategorieAliment extends StatefulWidget {
  const CategorieAliment({super.key});

  @override
  State<CategorieAliment> createState() => _CategorieAlimentState();
}

class _CategorieAlimentState extends State<CategorieAliment> {

     final Stream<QuerySnapshot> _produitRef = FirebaseFirestore.instance.collection('Produit').where('categorie', isEqualTo: "Aliments").snapshots();
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
             appBar: AppBar(
        title: const Text("Catégorie Aliment", style: TextStyle(color: Colors.deepOrange),),
                 ...
                 Column(
                  ...
                  children: [
                    ...
                    decoration: const BoxDecoration(
                      image: DecorationImage(
                        image: AssetImage('assets/aliment.png'),
                        fit: BoxFit.cover 
                        )
                    ),
                    ...
                    child: Container(
                      ...
                      child: Padding(padding: EdgeInsets.only(top:200),
                        child: Column(
                          children:const  [
                            Text("Retrouvez les meilleurs Aliments", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Colors.white),)
                          ],
                        ),
                      ),
                    ),
                  ...
                  Padding(
                                     ...
                                     child: Row(
                                                         ...
                                                         children: const [
                                                           Text("Catégorie Aliment", style: TextStyle(color: Colors.blue, fontWeight: FontWeight.bold,fontSize: 17),),
