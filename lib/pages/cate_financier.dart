...
class CategorieFiancier extends StatefulWidget {
  const CategorieFiancier({super.key});

  @override
  State<CategorieFiancier> createState() => _CategorieFiancierState();
}

class _CategorieFiancierState extends State<CategorieFiancier> {
   
  final Stream<QuerySnapshot> _produitRef = FirebaseFirestore.instance.collection('Prestataires').where('categorie', isEqualTo: "Financiers").snapshots();
  @override
...
Container(
    ...
    return Scaffold(
       appBar: AppBar(
        title: const Text("Catégorie Finance", style: TextStyle(color: Colors.deepOrange),),
                  ...
                  children: [
                    ...
                    child: Container(
                      ...
                      child: Padding(padding: EdgeInsets.only(top:200),
                        child: Column(
                          children:const  [
                            Text("Retrouvez les meilleurs Financiers", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Colors.white),)
                          ],
                        ),
                      ),
                    ),
                    ...
                    Padding(
                                     ...
                                     child: Row(
                                                         ...
                                                         children: const [
                                                           Text("Catégorie Financier", style: TextStyle(color: Colors.blue, fontWeight: FontWeight.bold,fontSize: 17),),
...
return Scaffold(
       appBar: AppBar(
        title: const Text("Categorie Finance", style: TextStyle(color: Colors.white),),
