...
class CategorieJardinerie extends StatefulWidget {
  const CategorieJardinerie({super.key});

  @override
  State<CategorieJardinerie> createState() => _CategorieJardinerieState();
}

class _CategorieJardinerieState extends State<CategorieJardinerie> {
  
  final Stream<QuerySnapshot> _produitRef = FirebaseFirestore.instance.collection('Prestataires').where('categorie', isEqualTo: "Jardiniers").snapshots();
  @override
...
Container(
    ...
    return Scaffold(
       appBar: AppBar(
        title: const Text("Catégorie Jardinier", style: TextStyle(color: Colors.deepOrange),),
                  ...
                  children: [
                    ...
                    decoration: const BoxDecoration(
                      image: DecorationImage(
                        image: AssetImage('assets/jardi.jpg'),
                        fit: BoxFit.cover 
                        )
                    ),
                    ...
                    child: Container(
                      ...
                      child: Padding(padding: EdgeInsets.only(top:200),
                        child: Column(
                          children:const  [
                            Text("Retrouvez les meilleurs Jardiniers", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Colors.white),)
                          ],
                        ),
                      ),
                    ),
                    ...
                    Padding(
                                     ...
                                     child: Row(
                                                         ...
                                                         children: const [
                                                           Text("Catégorie Jardinerie", style: TextStyle(color: Colors.blue, fontWeight: FontWeight.bold,fontSize: 17),),
 ...
 return Scaffold(
       appBar: AppBar(
        title: const Text("Catégorie Jardinier", style: TextStyle(color: Colors.white),),
