...
class CategorieMarketing extends StatefulWidget {
  const CategorieMarketing({super.key});

  @override
  State<CategorieMarketing> createState() => _CategorieMarketingState();
}

class _CategorieMarketingState extends State<CategorieMarketing> {
   
  final Stream<QuerySnapshot> _produitRef = FirebaseFirestore.instance.collection('Prestataires').where('categorie', isEqualTo: "Marketing Digital").snapshots();
  @override
...
Container(
    ...
    return Scaffold(
       appBar: AppBar(
        title: const Text("Catégorie Marketing", style: TextStyle(color: Colors.deepOrange),),
                  ...
                  children: [
                    ...
                    decoration: const BoxDecoration(
                      image: DecorationImage(
                        image: AssetImage('assets/makerting.png'),
                        fit: BoxFit.cover 
                        )
                    ),
                    ...
                    child: Container(
                      ...
                      child: Padding(padding: EdgeInsets.only(top:200),
                        child: Column(
                          children:const  [
                            Text("Retrouvez les meilleurs Vendeurs", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Colors.white),)
                          ],
                        ),
                      ),
                    ),
...
return Scaffold(
       appBar: AppBar(
        title: const Text("Catégorie Marketing", style: TextStyle(color: Colors.white),),
