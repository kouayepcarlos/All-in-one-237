...
class CategorieMenagere extends StatefulWidget {
  const CategorieMenagere({super.key});

  @override
  State<CategorieMenagere> createState() => _CategorieMenagereState();
}

class _CategorieMenagereState extends State<CategorieMenagere> {
   
  final Stream<QuerySnapshot> _produitRef = FirebaseFirestore.instance.collection('Prestataires').where('categorie', isEqualTo: "Menagéres").snapshots();
  @override
...
Container(
    ...
    return Scaffold(
       appBar: AppBar(
        title: const Text("Catégorie Ménagère", style: TextStyle(color: Colors.deepOrange),),
                  ...
                  children: [
                    ...
                    decoration: const BoxDecoration(
                      image: DecorationImage(
                        image: AssetImage('assets/menagere.jpg'),
                        fit: BoxFit.cover 
                        )
                    ),
                    ...
                    child: Container(
                      ...
                      child: Padding(padding: EdgeInsets.only(top:200),
                        child: Column(
                          children:const  [
                            Text("Retrouvez les meilleurs Ménagères", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Colors.white),)
                          ],
                        ),
                      ),
                    ),
...
return Scaffold(
       appBar: AppBar(
        title: const Text("Catégorie Ménagère", style: TextStyle(color: Colors.white),),
