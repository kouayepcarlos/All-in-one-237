...
class CategorieCoiffeuse extends StatefulWidget {
  const CategorieCoiffeuse({super.key});

  @override
  State<CategorieCoiffeuse> createState() => _CategorieCoiffeuseState();
}

class _CategorieCoiffeuseState extends State<CategorieCoiffeuse> {
  
   final Stream<QuerySnapshot> _produitRef = FirebaseFirestore.instance.collection('Prestataires').where('categorie', isEqualTo: "Coiffeuses").snapshots();
...
Container(
    ...
    return Scaffold(
       appBar: AppBar(
        title: const Text("Catégorie Coiffeuse", style: TextStyle(color: Colors.deepOrange),),
          ...
          children: [
                  ...
                  children: [
                    ...
                    decoration: const BoxDecoration(
                      image: DecorationImage(
                        image: AssetImage('assets/coiffese.jpg'),
                        fit: BoxFit.cover 
                        )
                    ),
                    ...
                    child: Container(
                      ...
                      child: Padding(padding: EdgeInsets.only(top:200),
                        child: Column(
                          children:const  [
                            Text("Retrouvez les meilleurs Coiffeuses", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Colors.white),)
                          ],
                        ),
                      ),
                    ),
                 ...
                 Padding(
                                     ...
                                     child: Row(
                                                         ...
                                                         children: const [
                                                           Text("Catégorie Coiffeuse", style: TextStyle(color: Colors.blue, fontWeight: FontWeight.bold,fontSize: 17),),
 ...
 return Scaffold(
       appBar: AppBar(
        title: const Text("Catégorie Coiffeuse", style: TextStyle(color: Colors.white),),
