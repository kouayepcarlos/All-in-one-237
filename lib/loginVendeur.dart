...
import 'package:all_in_one/pages/global.dart';
import 'package:all_in_one/pages/loading.dart';
import 'package:all_in_one/services/authentification.dart';
...
class LoginVendeur extends StatefulWidget {
  const LoginVendeur({super.key});

  @override
  State<LoginVendeur> createState() => _LoginVendeurState();
}

class _LoginVendeurState extends State<LoginVendeur> {
    String email = '';
  String password = '';
 ...
 final AuthentificationService _auth = AuthentificationService();
  ...
  Widget build(BuildContext context) {
    return  loading ? Loading(): Scaffold(
      appBar: AppBar(
        title: const Text("Connexion Vendeur", style: TextStyle(color: Colors.white),),
                ...
                children: [
                  ...
                  child: Container(
                    ...
                    child: Padding(padding: EdgeInsets.only(top:200),
                      child: Column(
                        children:const  [
                          Text("Veillé vous connectez cher vendeur", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Colors.white),)
                        ],
                      ),
                    ),
                  ),
